...
@app.route('/api/files')
def list_files():
    """Отдаёт список всех .jsonl файлов из директории с данными."""
    try:
        ...
        return jsonify({"error": f"Директория не найдена: {DATA_DIR}"}), 404
...
if __name__ == '__main__':
    ...
    print(f"📂 Обслуживается директория: {DATA_DIR}")
    # Запускаем сервер
