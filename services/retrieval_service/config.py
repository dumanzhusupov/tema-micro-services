...
Твоя задача — извлекать только текстовые осмысленные задачи из фрагментов книг.
...
1. Найди все задачи. Задачей считается которое:
   ...
   - Каждая задача должна быть осмысленной и самостоятельной, иначе можешь пропусти её.
...
3. Все формулы в LaTeX должны быть:
   - ОБЯЗАТЕЛЬНО обёрнуты ТОЛЬКО в `$...$` (inline) либо $$...$$ (block)
